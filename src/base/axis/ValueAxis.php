...
namespace simialbi\yii2\chart\base\axis;
...
{
    /**
     * @var float A base value.
     *
     * This is a threshold value that will divide "positive" and "negative" value ranges.
     *
     * Other scale-related functionality also depend on base value. E.g. stacks, value-dependent coloring, etc.
     */
    public $baseValue;
