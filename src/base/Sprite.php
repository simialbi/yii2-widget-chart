...
use simialbi\yii2\chart\base\style\LinearGradient;
use simialbi\yii2\chart\base\style\Pattern;
use simialbi\yii2\chart\base\style\RadialGradient;
...
class Sprite extends BaseObject
{
     ...
     */
    public $shapeRendering = self::SHAPE_RENDERING_AUTO;
     ...
     */
    public $urlTarget = self::URL_TARGET_SELF;
